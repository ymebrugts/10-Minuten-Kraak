...
public class FXView {
    ...
    public void lobby() throws IOException {
        top.setLeft(null);
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("FXML/lobbyMenu.fxml"));
    ...
    @FXML public void showHand() throws IOException, NotBoundException {
        if (DraworUpdate == 0) {
            FXMLLoader fxmlLoader2 = new FXMLLoader(getClass().getResource("FXML/Hand.fxml"));
